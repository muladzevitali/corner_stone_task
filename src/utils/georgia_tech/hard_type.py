...
def all_type_gt(data):
    ...
    percent_hard = [divide(a, b) for a, b in zip(off_speed_swing, off_speed_total) if isinstance(a, int)]
    percent_hard = ['Swing %'] + percent_hard
    ...
    totals = [a + b for a, b in zip(off_speed_total, off_speed_total) if isinstance(a, int)]
